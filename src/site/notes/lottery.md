...
<body>
    <div class="home-screen active" id="homeScreen">
        ...
        <div class="game-select">
            ...
            <button class="game-btn" data-game="55">6/55</button>
        </div>
    </div>
